...
<head>
    ...
    <link rel="stylesheet"
        href="{{ asset('/vendor/AdminLTE-3.2.0/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css') }}">
    <!-- iCheck -->
    <link rel="stylesheet"
        href="{{ asset('/vendor/AdminLTE-3.2.0/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
    <!-- JQVMap -->
    ...
    <!-- overlayScrollbars -->
    <link rel="stylesheet"
        href="{{ asset('/vendor/AdminLTE-3.2.0/plugins/overlayScrollbars/css/OverlayScrollbars.min.css') }}">
    <!-- Daterange picker -->
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <img class="animation__shake" src="{{ asset('/vendor/AdminLTE-3.2.0/dist/img/AdminLTELogo.png') }}" alt="AdminLTELogo" height="60" width="60">
  </div> --}}
        <!-- Navbar -->
    ...
    <!-- Tempusdominus Bootstrap 4 -->
    <script
        src="{{ asset('/vendor/AdminLTE-3.2.0/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js') }}">
    </script>
    <!-- Summernote -->
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            @if (session('error'))
                document.querySelector("#failed-notification-content .message").innerHTML =
                    "{{ session('error') }}";
                window.Toastify({
            ...
            @endif
            @if (session('success'))
                document.querySelector("#success-notification-content .message").innerHTML =
                    "{{ session('success') }}";
                window.Toastify({
